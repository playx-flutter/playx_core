...
/// Convert any map value with [key] to [Map] or null safely.
...
/// Convert any map value with [key] to [List] of type [int] or null safely.
...
/// Convert any map value with [key] to [List] of type [T] or null safely.
...
/// Convert any map value with [key] to [Map] or [fallback] safely.
/// Throws a [FormatException] if the conversion fails.
...
/// Convert any map value with [key] to [List] of type [T] or [fallback] safely.
/// Throws a [FormatException] if the conversion fails.
List<T> asListT<T>(
  dynamic json,
  String key,
...
/// Convert any map value with [key] to [List] of type [int] or [fallback] safely.
/// Throws a [FormatException] if the conversion fails.
List<int> asListInt(
  dynamic json,
  String key,
...
/// Convert any map value with [key] to [List] of type [String] or [fallback] safely.
/// Throws a [FormatException] if the conversion fails.
